/**
   $MILM - MomIdLikeToMint
   
   - Deflationary system. Burn + Charity + Holder Rewards
   - Token holders are rewarded through a redistribution fee on every transaction.
   - The MILM smart contract comes with burn designed to help the price remain stable and grow.
   - Chairty fund allocation into the Suga Momma Fund to support women based and led organizations and projects globally.
   
   📱 Telegram: https://t.me/MILMNFT
   🌎 Website: https://www.milmnft.com
   🌐 Twitter: https://twitter.com/MILMNFT
*/
...
pragma solidity ^0.6.12;
    ...
    contract MILM is Context, IERC20, Ownable {
        ...
        string private _name = 'MILM Token';
